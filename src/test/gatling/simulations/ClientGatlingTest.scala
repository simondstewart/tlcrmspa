...
class ClientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Client entity")
        ...
        .repeat(2) {
            ...
            .post("/api/clients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "website":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "crmEntryType":"SAMPLE_TEXT", "industryType":"SAMPLE_TEXT", "accountManagerId":null, "externalCode":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
